...
func (uc *UserCreate) SetOpenpid(s string) *UserCreate {
	uc.mutation.SetOpenpid(s)
	return uc
}

// SetNillableOpenpid sets the "openpid" field if the given value is not nil.
func (uc *UserCreate) SetNillableOpenpid(s *string) *UserCreate {
	if s != nil {
		uc.SetOpenpid(*s)
	}
	return uc
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if value, ok := uc.mutation.Openpid(); ok {
